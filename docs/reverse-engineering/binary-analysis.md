...
![ELF-format.png](../assets/Reverse%20Engineering/ELF-format.png)
...
- Lazy binding in Linux ELF binaries is implemented with the help of two special sections, called the **Procedure Linkage Table** (.plt) and the **Global Offset Table** (.got)
 ...
 ![calling a shared library via plt.png](../assets/Reverse%20Engineering/calling%20a%20shared%20library%20via%20plt.png)
