...
- `[[Note Title]]`
- `[[Note Title|Alias]]`
- `![image.png](../../assets/.github/agents/image.png)`
- `![Alt text](../../assets/.github/agents/image.png)`
...
2. **Image embeds**:
   ...
   - Rewrite to standard Markdown image syntax, with a new relative path from the new note location to `docs/assets/...`:
     - `![image.png](../../assets/.github/agents/image.png)` → `![image](../../assets/.github/agents/image.png)`
     - `![Cool diagram](../../assets/.github/agents/image.png)` → `![Cool diagram](../../assets/.github/agents/image.png)`

### 2. Standard Markdown image links

Also handle regular Markdown images:

- `![alt](../../assets/.github/agents/image.png)`
