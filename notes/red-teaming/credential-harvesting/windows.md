...
1. **[Process memory](#process-memory)**
	...
	- [3- mimikatz](#3-mimikatz)
2. **[Abusing logging tracing](#abusing-logging-tracing)**
	- [1- Tracing the WinINet provider](#1-tracing-the-wininet-provider)
	- [2- Decrypting TLS traffic using TLS key logging Not working on latest firefox and chrome](#2-decrypting-tls-traffic-using-tls-key-logging-not-working-on-latest-firefox-and-chrome)
	- [3- Peeking at shell command-line history files](#3-peeking-at-shell-command-line-history-files)
	- [4- Command line arguments](#4-command-line-arguments)
3. **[Windows Credential Manager](#windows-credential-manager)**
4. **[Phishing and credential dialog spoofing](#phishing-and-credential-dialog-spoofing)**
5. **[Password spray attacks](#password-spray-attacks)**
---
 # Process memory:
 ## 1- Procdump.exe
 ```powershell
