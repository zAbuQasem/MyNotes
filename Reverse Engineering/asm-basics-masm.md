...
![Nasm structure](attachments/Nasm%20structure.png)
...
- **Syntax**
![variable statement](attachments/variable%20statement.png)
...
- **Example**
![define strings](attachments/define%20strings.png)
...
```
### Operand notation
![operand notation](attachments/operand%20notation.png)
# Data Transfer Instructions
## MOV instruction
...
```
![arithmeticinHLL](attachments/arithmeticinHLL.png)
...
![littleEndian](attachments/littleEndian.png)

- **PTR example**

![PTRexample](attachments/PTRexample.png)
...
![spanningmultiplelines](attachments/spanningmultiplelines.png)

- **Anonymous data**
![anonymousdata](attachments/anonymousdata.png)
...
![offsetpic](attachments/offsetpic.png)
- **Example**: 
